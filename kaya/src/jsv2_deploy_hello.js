...
async function testBlockchain() {
    try {
        ...
        // Deploy a contract
        const code = fs.readFileSync('contract/Hello.scilla', 'utf-8');
        ...
        // Deploy a contract
        const caller_code = fs.readFileSync('contract/HelloCaller.scilla', 'utf-8');

        const caller_init = [
            {
                vname: 'callee_address',
                type: 'ByStr20',
                value: `0x${hello.address}`,
            },
        ];
        ...
        const callTx = await caller_hello.call('callHello', [
        ])
        ...
        const Hellostate = await hello.getState();
        console.log(Hellostate, 'hellostate');
